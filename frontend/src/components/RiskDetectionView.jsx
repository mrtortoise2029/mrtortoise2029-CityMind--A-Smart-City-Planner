...
const severityColor = { LOW: '#62dbaa', MEDIUM: '#e4bd65', HIGH: '#ed8f55', CRITICAL: '#ef7379' };
...
export function RiskDetectionView({ onOpenMap, project }) {
